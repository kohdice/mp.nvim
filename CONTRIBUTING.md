# Contributing to mp.nvim

Thank you for considering contributing to **mp.nvim**!
...
Together, we can make **mp.nvim** even better!
...
CI runs the same two checks on every push and pull request. Please run them locally
before pushing:

```bash
# Format (use `stylua --check .` to verify without writing)
stylua .
...
Thank you for your contributions, big or small, in making **mp.nvim** better!
